...
local Lucent = {
	Version = 'Lucent-1.4, modified by Ashuni'
};
...
local LocalPlayer : Player = Lucent.Services.Players.LocalPlayer;
local Mouse = LocalPlayer:GetMouse();

Lucent.ProtectGui = protect_gui or protectgui or (syn and syn.protect_gui) or function() end;
Lucent.Services.CoreGui = (gethui and gethui()) or Lucent.Services.CoreGui or LocalPlayer.PlayerGui;
Lucent.MinimumTabSize = 600;

local Services : Services = Lucent.Services;

function Lucent:IsMouseOverFrame(Frame)
...
function Lucent:NewInput(frame : Frame , call) : TextButton
...
function Lucent:CreateGradient(parent, colors, rotation, transparency)
	...
	if transparency then
		...
		for i, trans in ipairs(transparency) do
			table.insert(transKeypoints, NumberSequenceKeypoint.new((i-1)/(#transparency-1), trans))
		end
...
-- Enhanced blur effect with better performance
function Lucent:SetBlur(frame : Frame, NoAutoBackground, intensity)
	...
	Part.CanQuery = false;
	Part.CollisionGroup = Lucent:RandomString();
	...
	DepthOfField.Name = Lucent:RandomString();
	Part.Name = Lucent:RandomString();
	SurfaceGui.Name = Lucent:RandomString();
		...
		local _,updatec = pcall(function()
			...
			if not NoAutoBackground then
				if qualityLevel < 8 then
					TweenService:Create(Part,TweenInfo.new(0.5,Enum.EasingStyle.Quint,Enum.EasingDirection.Out),{
						Transparency = 1;
					}):Play()
...
function Lucent:GetIcon(name : string) : string
	local icons = {
...
function Lucent:RandomString() : string
...
function Lucent:Rounding(num, numDecimalPlaces) : number
...
Lucent.Theme = {
	...
	BackgroundGradient = {Color3.fromRGB(35, 35, 35), Color3.fromRGB(28, 28, 28)},
	SectionColor = Color3.fromRGB(23, 23, 23),
	SectionGradient = {Color3.fromRGB(26, 26, 26), Color3.fromRGB(20, 20, 20)},
	Hightlight = Color3.fromRGB(161, 208, 42),
	HighlightGradient = {Color3.fromRGB(161, 208, 42), Color3.fromRGB(140, 185, 35)},
...
function Lucent:SetTheme(name)
	...
	elseif name == "Frost" then
		Lucent.Theme = {
			WindowBackgroundColor = Color3.fromRGB(8, 15, 25),
			WindowGradient = {Color3.fromRGB(12, 20, 35), Color3.fromRGB(5, 10, 20)},
			HeadText = Color3.fromRGB(220, 235, 255),
			LineColor = Color3.fromRGB(25, 45, 75),
			BackgroundColor = Color3.fromRGB(15, 25, 45),
			BackgroundGradient = {Color3.fromRGB(20, 30, 50), Color3.fromRGB(10, 20, 40)},
			SectionColor = Color3.fromRGB(10, 18, 35),
			SectionGradient = {Color3.fromRGB(15, 25, 40), Color3.fromRGB(8, 15, 30)},
			Hightlight = Color3.fromRGB(100, 180, 255),
			HighlightGradient = {Color3.fromRGB(120, 200, 255), Color3.fromRGB(80, 160, 235)},
			StrokeColor = Color3.fromRGB(30, 50, 80),
			StrokeColor2 = Color3.fromRGB(100, 150, 200),
			BackgroundColor2 = Color3.fromRGB(12, 20, 35),
			IconColor = Color3.fromRGB(150, 200, 255),
			AccentColor = Color3.fromRGB(100, 180, 255),
		}
	elseif name == "DarkOmens" then
		Lucent.Theme = {
			WindowBackgroundColor = Color3.fromRGB(15, 8, 25),
			WindowGradient = {Color3.fromRGB(20, 12, 35), Color3.fromRGB(10, 5, 20)},
			HeadText = Color3.fromRGB(220, 180, 255),
			LineColor = Color3.fromRGB(45, 25, 75),
			BackgroundColor = Color3.fromRGB(25, 15, 45),
			BackgroundGradient = {Color3.fromRGB(30, 20, 50), Color3.fromRGB(20, 10, 40)},
			SectionColor = Color3.fromRGB(18, 10, 35),
			SectionGradient = {Color3.fromRGB(25, 15, 40), Color3.fromRGB(15, 8, 30)},
			Hightlight = Color3.fromRGB(180, 100, 255),
			HighlightGradient = {Color3.fromRGB(200, 120, 255), Color3.fromRGB(160, 80, 235)},
			StrokeColor = Color3.fromRGB(50, 30, 80),
			StrokeColor2 = Color3.fromRGB(150, 100, 200),
			BackgroundColor2 = Color3.fromRGB(20, 12, 35),
			IconColor = Color3.fromRGB(200, 150, 255),
			AccentColor = Color3.fromRGB(180, 100, 255),
		}
	elseif name == "Neon" then
		Lucent.Theme = {
			WindowBackgroundColor = Color3.fromRGB(5, 5, 5),
			WindowGradient = {Color3.fromRGB(10, 10, 10), Color3.fromRGB(2, 2, 2)},
			HeadText = Color3.fromRGB(0, 255, 150),
			LineColor = Color3.fromRGB(0, 80, 40),
			BackgroundColor = Color3.fromRGB(15, 15, 15),
			BackgroundGradient = {Color3.fromRGB(20, 20, 20), Color3.fromRGB(10, 10, 10)},
			SectionColor = Color3.fromRGB(8, 8, 8),
			SectionGradient = {Color3.fromRGB(12, 12, 12), Color3.fromRGB(5, 5, 5)},
			Hightlight = Color3.fromRGB(0, 255, 150),
			HighlightGradient = {Color3.fromRGB(50, 255, 180), Color3.fromRGB(0, 200, 120)},
			StrokeColor = Color3.fromRGB(0, 100, 50),
			StrokeColor2 = Color3.fromRGB(0, 150, 75),
	...
	elseif name == "Sunset" then
		Lucent.Theme = {
			WindowBackgroundColor = Color3.fromRGB(25, 15, 8),
			WindowGradient = {Color3.fromRGB(35, 20, 12), Color3.fromRGB(20, 10, 5)},
			HeadText = Color3.fromRGB(255, 220, 180),
			LineColor = Color3.fromRGB(75, 45, 25),
			BackgroundColor = Color3.fromRGB(45, 25, 15),
			BackgroundGradient = {Color3.fromRGB(50, 30, 20), Color3.fromRGB(40, 20, 10)},
			SectionColor = Color3.fromRGB(35, 18, 10),
			SectionGradient = {Color3.fromRGB(40, 25, 15), Color3.fromRGB(30, 15, 8)},
			Hightlight = Color3.fromRGB(255, 150, 50),
			HighlightGradient = {Color3.fromRGB(255, 180, 80), Color3.fromRGB(235, 120, 30)},
			StrokeColor = Color3.fromRGB(80, 50, 30),
			StrokeColor2 = Color3.fromRGB(200, 150, 100),
			BackgroundColor2 = Color3.fromRGB(35, 20, 12),
			IconColor = Color3.fromRGB(255, 200, 150),
			AccentColor = Color3.fromRGB(255, 150, 50),
		}
	elseif name == "Ocean" then
		Lucent.Theme = {
			WindowBackgroundColor = Color3.fromRGB(8, 20, 30),
			WindowGradient = {Color3.fromRGB(12, 25, 40), Color3.fromRGB(5, 15, 25)},
			HeadText = Color3.fromRGB(180, 220, 255),
			LineColor = Color3.fromRGB(25, 60, 90),
			BackgroundColor = Color3.fromRGB(15, 35, 55),
			BackgroundGradient = {Color3.fromRGB(20, 40, 60), Color3.fromRGB(10, 30, 50)},
			SectionColor = Color3.fromRGB(10, 25, 40),
			SectionGradient = {Color3.fromRGB(15, 30, 45), Color3.fromRGB(8, 20, 35)},
			Hightlight = Color3.fromRGB(50, 150, 255),
			HighlightGradient = {Color3.fromRGB(80, 170, 255), Color3.fromRGB(30, 130, 235)},
			StrokeColor = Color3.fromRGB(30, 70, 100),
			StrokeColor2 = Color3.fromRGB(100, 170, 220),
			BackgroundColor2 = Color3.fromRGB(12, 25, 40),
...
function Lucent.new(config)
	config = config or {};

	config.Name = config.Name or "ENHANCED LUCENT";
	...
	config.Shadow = config.Shadow or true;
	config.Theme = config.Theme or "Default";

	-- Apply theme
	Lucent:SetTheme(config.Theme);
	...
	local WindowGradient = Lucent:CreateGradient(nil, Lucent.Theme.WindowGradient, 45)
	...
	Content.Name = Lucent:RandomString()
	...
	Lucent.ProtectGui(Content);

	WindowFrame.Name = Lucent:RandomString()
	WindowFrame.Parent = Content
	WindowFrame.BackgroundColor3 = Lucent.Theme.WindowBackgroundColor
	...
	if config.Shadow then
		...
		DropShadow.Name = Lucent:RandomString()
	...
	-- Smooth window appearance animation
	TweenService:Create(WindowFrame,TweenInfo.new(1.2,Enum.EasingStyle.Quint,Enum.EasingDirection.InOut),{
		Size = config.Scale,
	...
	if config.Acrylic then
		Lucent:SetBlur(WindowFrame, false, 1.2)
	end;
	...
	UIStroke.Color = Lucent.Theme.AccentColor
	UIStroke.Parent = WindowFrame

	Header.Name = Lucent:RandomString()
	...
	task.delay(0.3,function()
		TweenService:Create(Header,TweenInfo.new(1.2,Enum.EasingStyle.Quint,Enum.EasingDirection.InOut),{
			Position = UDim2.new(0,0,0,0)
		}):Play()
	end)

	HeaderText.Name = Lucent:RandomString()
	...
	HeaderText.TextColor3 = Lucent.Theme.HeadText
	HeaderText.TextScaled = true
	HeaderText.TextSize = 14.000
	HeaderText.TextWrapped = true

	-- Add text gradient effect
	local headerGradient = Lucent:CreateGradient(HeaderText, {Lucent.Theme.HeadText, Lucent.Theme.AccentColor}, 90)
	...
	Line.Name = Lucent:RandomString()
	Line.Parent = Header
	Line.AnchorPoint = Vector2.new(0, 1)
	Line.BackgroundColor3 = Lucent.Theme.LineColor
	...
	local lineGradient = Lucent:CreateGradient(Line, {Lucent.Theme.AccentColor, Lucent.Theme.LineColor}, 0, {0.3, 0.8})
	...
	SearchFrame.Name = Lucent:RandomString()
	...
	SearchButton.Name = Lucent:RandomString()
	...
	UIStroke_2.Color = Lucent.Theme.LineColor;
	...
	SettingsButton.Name = Lucent:RandomString()
	...
	MinButton.Name = Lucent:RandomString()
	...
	Line_2.Name = Lucent:RandomString()
	Line_2.Parent = WindowFrame
	Line_2.BackgroundColor3 =Lucent.Theme.LineColor
	Line_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
	Line_2.BorderSizePixel = 0
	Line_2.Position = UDim2.new(0, 170, 0, 0)
	Line_2.Size = UDim2.new(0, 1, 1, 0)

	BthFrames.Name = Lucent:RandomString()
	...
	InformationFrame.Name = Lucent:RandomString()
	...
	ProfileIcon.Name = Lucent:RandomString()
	...
	UIStroke_3.Color =Lucent.Theme.LineColor
	UIStroke_3.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	UIStroke_3.Parent = ProfileIcon

	UsernameText.Name = Lucent:RandomString()
	...
	TabButtons.Name = Lucent:RandomString()
	...
	TBSFrame.Name = Lucent:RandomString()
	...
	function WindowSignal:StatusBar()
		...
		Statusbar.Name = Lucent:RandomString();
		...
		return {
			create = function(name)
				...
				Frame.BackgroundColor3 = Lucent.Theme.WindowBackgroundColor
				...
				Label.Name = Lucent:RandomString()
				Label.Parent = Frame
	...
	function WindowSignal:AddLabel(name)
		...
		TBSTitle.Name = Lucent:RandomString()
	...
	function WindowSignal:AddTab(config)
		...
		TabButton.Name = Lucent:RandomString()
		TabButton.Parent = TBSFrame
		TabButton.BackgroundColor3 = Lucent.Theme.BackgroundColor2
		...
		TabIcon.Name = Lucent:RandomString()
		...
		TabIcon.ZIndex = 5
		TabIcon.Image = Lucent:GetIcon(config.Icon);
		TabIcon.ImageTransparency = 1
		TabIcon.ImageColor3 = Lucent.Theme.IconColor

		TabName.Name = Lucent:RandomString()
		...
		TabFrame.Name = Lucent:RandomString()
		...
		CTFrame.Name = Lucent:RandomString()
		...
		LeftFrame.Name = Lucent:RandomString()
		...
		RightFrame.Name = Lucent:RandomString()
		...
		task.spawn(function()
			while true do task.wait(0.1)
				if WindowSignal.Config.Scale.X.Offset <= Lucent.MinimumTabSize or config.SingleMode then
		...
		Lucent:NewInput(TabButton,function()
		...
		function TabSignal:AddSection(Config)
			...
			Section.Name = Lucent:RandomString()
			Section.Parent = (string.lower(Config.Position) == "left" and LeftFrame) or RightFrame;
			Section.BackgroundColor3 = Lucent.Theme.SectionColor
			...
			UIStroke.Color = Lucent.Theme.BackgroundColor
			...
			Frame.BackgroundColor3 = Lucent.Theme.BackgroundColor
			Frame.BorderColor3 = Color3.fromRGB(0, 0, 0)
			Frame.BorderSizePixel = 0
			...
			function SectionSignal:AddToggle(config)
				...
				Toggle.Name = Lucent:RandomString()
				...
				sys.BackgroundColor3 = Lucent.Theme.BackgroundColor
				...
				color.BackgroundColor3 = Lucent.Theme.Hightlight
				...
				UIStroke.Color = Lucent.Theme.StrokeColor
				UIStroke.Parent = sys
				...
				local setValue = function(value)
					if value then
						TweenService:Create(color,TweenInfo.new(0.2),{
							...
							BackgroundColor3 = Lucent.Theme.Hightlight
						}):Play()
				...
				Lucent:NewInput(Toggle,function()
					if not Content.Enabled or not Content.Parent then
						return;
					end;
			...
			function SectionSignal:AddButton(config)
				...
				Button.Name = Lucent:RandomString()
				Button.Parent = Section
				Button.BackgroundColor3 = Lucent.Theme.BackgroundColor
				...
				local button = Lucent:NewInput(Button,function()
					if not Content.Enabled or not Content.Parent then
						return;
					end;
				...
				button.MouseLeave:Connect(function()
					TweenService:Create(Button,TweenInfo.new(0.1),{
						BackgroundColor3 = Lucent.Theme.BackgroundColor
					}):Play()
				end)
			...
			function SectionSignal:AddSlider(config)
				...
				Slider.Name = Lucent:RandomString()
				...
				value.BackgroundColor3 = Lucent.Theme.BackgroundColor
				...
				con.BackgroundColor3 = Lucent.Theme.BackgroundColor
				...
				UIStroke_2.Color = Lucent.Theme.StrokeColor
				UIStroke_2.Parent = con

				block.Name = "block"
				block.Parent = con
				block.BackgroundColor3 = Lucent.Theme.Hightlight
				...
				move.BackgroundColor3 = Lucent.Theme.Hightlight
				...
				local function update(Input)
					...
					local Value = Lucent:Rounding(Main,config.Round);
				...
				Services.UserInputService.InputChanged:Connect(function(Input)
					if IsHold then
						...
						if Services.UserInputService.TouchEnabled then
							if not Lucent:IsMouseOverFrame(Slider) then
								IsHold = false
							end;
						end;
					end
			...
			function SectionSignal:AddKeybind(config)
				...
				Keybind.Name = Lucent:RandomString()
				...
				value.TextColor3 = Lucent.Theme.Hightlight;
				...
				local Button = Lucent:NewInput(Keybind);
			...
			function SectionSignal:AddDropdown(config)
				...
				Dropown.Name = Lucent:RandomString()
				...
				value.Name = Lucent:RandomString()
				value.Parent = sys
				value.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				value.BackgroundTransparency = 1.000
				value.BorderColor3 = Color3.fromRGB(0, 0, 0)
				...
				DropdownItems.Name = Lucent:RandomString()
				DropdownItems.Parent = Content
				DropdownItems.BackgroundColor3 = Lucent.Theme.WindowBackgroundColor
				...
				Scroll.Name = Lucent:RandomString()
				...
				Services.UserInputService.InputBegan:Connect(function(input)
					if input.UserInputType ~= Enum.UserInputType.MouseButton1 or input.UserInputType ~= Enum.UserInputType.Touch then
						if not Lucent:IsMouseOverFrame(DropdownItems) then
				...
				local CreateButton = function(name,val)
					...
					Selected.Name = Lucent:RandomString()
					Selected.Parent = Scroll
					Selected.BackgroundColor3 = Lucent.Theme.BackgroundColor2
					Selected.BorderColor3 = Color3.fromRGB(0, 0, 0)
					Selected.BorderSizePixel = 0
					Selected.Size = UDim2.new(1, 0, 0, 25)
					Selected.ZIndex = 102

					Icon.Name = Lucent:RandomString()
					...
					UIStroke.Color = Lucent.Theme.StrokeColor2
					...
					for i,v in next,config.Values do
						...
						local call = function(v)
							if v then
								...
								Icon.ImageColor3 = Lucent.Theme.Hightlight;
							else
						...
						Lucent:NewInput(Selected,function()
							if not Content.Enabled or not Content.Parent then
								return;
							end;
				...
				local upd = Lucent:NewInput(Dropown);
		...
		function TabSignal:Icon(new)
			TabIcon.Image = Lucent:GetIcon(new);
		end;
	...
	if config.Resizable then
		...
		Resize.Name = Lucent:RandomString();
		...
		label.Image = Lucent:GetIcon('minimize-2')
...
function Lucent:CreateNotifier()
	local Content = Instance.new("ScreenGui")
	...
	Notification.Name = Lucent:RandomString()
	Notification.Parent = Content
	Notification.AnchorPoint = Vector2.new(1, 1)
	Notification.BackgroundColor3 = Lucent.Theme.WindowBackgroundColor
	...
	return {
		new = function(head , body , duration)
			...
			Notify.Name = Lucent:RandomString()
			Notify.Parent = Notification
			Notify.BackgroundColor3 = Lucent.Theme.WindowBackgroundColor
			...
			local notifyGradient = Lucent:CreateGradient(Notify, Lucent.Theme.WindowGradient, 45)
			...
			Header.Text = head
			Header.TextColor3 = Lucent.Theme.HeadText
			Header.TextSize = 14.000
			Header.TextTransparency = 0.100
			Header.TextXAlignment = Enum.TextXAlignment.Left

			Body.Name = Lucent:RandomString()
			Body.Parent = Notify
			...
			TweenService:Create(Notify,TweenInfo.new(0.3,Enum.EasingStyle.Quint),{
				Size = UDim2.new(0, math.clamp(scale.X + 25 , Min.X + 10 , 300), 0, scale.Y + 25)
			}):Play()

			task.delay(duration or 5,function()
				TweenService:Create(Notify,TweenInfo.new(0.5,Enum.EasingStyle.Quint),{
					Size = UDim2.new(0, 0, 0, 0),
					BackgroundTransparency = 1
				}):Play()
